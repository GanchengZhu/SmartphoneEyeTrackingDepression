...
public class BitmapUtils {
    ...
    public static Bitmap geteyeroi(Bitmap bitmap, RectF rect) {
        Bitmap dstArea = Bitmap.createBitmap((int) (rect.width()), (int) (rect.height()),
                Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(dstArea);
        canvas.translate(-rect.left, -rect.top);
    ...
    public static float result_final(float gaze) {

        BigDecimal data_tmp = new BigDecimal(gaze);
        float gaze_result = data_tmp.setScale(3, BigDecimal.ROUND_HALF_UP).floatValue();
