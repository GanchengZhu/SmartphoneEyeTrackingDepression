//package com.example.gaze.record.renderer;
//
//
//import static com.example.gaze.record.common.rendering.ShaderUtil.loadGLShader;
//
...
//            AugmentedFace face, Camera camera, float [] distance) {
//
//
...
//        //GLES20.gl
//        GLES20.glDrawArrays(GLES20.GL_POINTS, 0, vertices.limit() / 3);
...
//
//        /*
//        ServerMessage SM = new ServerMessage(vertices,SS);
//
...
////        Log.d(TAG, "cameraPose: " + cameraPose);
//        distance[0] = computeDistance(left, cameraPose);
//        distance[1] = computeDistance(right, cameraPose);
//
//    }
//
//    public float computeDistance(Pose eye, Pose camera) {
//        float dx = eye.tx() - camera.tx();
//        float dy = eye.ty() - camera.ty();
//        float dz = eye.tz() - camera.tz();
