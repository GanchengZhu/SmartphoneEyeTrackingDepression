...
//ifstream face_gride_text("/home/zs/face_landmark/output/face_gride_data_save.txt");
...
void handle_rgb(std::string path)
{
  ...
  //  std::string save_name_righteye="/home/zs/face_landmark/output/face_image/"+image_file_save+"_right_eye.jpg";
  //  std::string save_name_lefteye="/home/zs/face_landmark/output/left_eye_image/"+image_file_save+"_left_eye.jpg";
  //  std::string save_name_face="/home/zs/face_landmark/output/right_eye_image/"+image_file_save+"_face.jpg";

  std::string save_name_righteye="/home/zs/face_landmark/output/right_eye_image/"+image_file_save+".jpg";
  std::string save_name_lefteye="/home/zs/face_landmark/output/left_eye_image/"+image_file_save+".jpg";
  std::string save_name_face="/home/zs/face_landmark/output/face_image/"+image_file_save+".jpg";
  ...
  string target2="00029/";
  int pos2 = image_file_save.find(target2);
  int n2 = target.size();
  image_file_save = image_file_save.erase(pos2,n2);


  face_gride_text.open("/home/zs/face_landmark/output/face_gride/00029/face_gride_data_save.txt",ios::app|ios::out);
...
int main(int argc, char **argv)
{
  ...
  DIR * dir;
  struct dirent * ptr;
  dir = opendir("/home/zs/face_landmark/sample/src/FaceDemo/resources/image/00029/image"); //打开一个目录

  std::string img_dir = "/home/zs/face_landmark/sample/src/FaceDemo/resources/image/00029/image";
